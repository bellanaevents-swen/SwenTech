...
function setLanguage(lang) {
  ...
  // Update dynamic projects if we are on the projects page
  if (typeof renderDynamicProjects === 'function') {
...
async function renderDynamicProjects() {
  ...
  try {
    ...
    projects.forEach(proj => {
      ...
      const desc = proj[`desc_${currentLang}`] || proj.desc_en;
      ...
      card.innerHTML = `
        ...
        <div class="card-meta">
          ...
          <div style="display: flex; gap: 0.5rem; align-items: center;">
            ${isAdmin ? `<button class="delete-project-btn" data-id="${proj.id}" title="Delete Project" style="background: none; border: none; color: #ef4444; cursor: pointer; font-size: 1rem; padding: 0.25rem; transition: transform 0.2s; display: inline-flex; align-items: center; justify-content: center;"><i class="fa-solid fa-trash"></i></button>` : ''}
    ...
    // Wire up delete event listeners with beautiful iframe-friendly custom verification modal
    if (isAdmin) {
...
function showAddProjectModal() {
  ...
  box.innerHTML = `
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem; border-bottom: 1px solid rgba(255, 255, 255, 0.05); padding-bottom: 0.75rem;">
      <h3 style="margin: 0; font-size: 1.5rem; font-weight: 600; color: #ffffff;"><i class="fa-solid fa-diagram-project" style="color: #3b82f6; margin-right: 8px;"></i>Add New Project</h3>
    ...
    <form id="add-project-form" style="display: flex; flex-direction: column; gap: 1.25rem;">
      ...
      <div class="tab-content" id="tab-en" style="display: flex; flex-direction: column; gap: 1rem;">
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
          <div style="display: flex; flex-direction: column; gap: 0.35rem;">
            ...
            <input type="text" id="proj-title-en" required placeholder="Project One" style="width: 100%; padding: 0.6rem 0.85rem; border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.1); background: rgba(255, 255, 255, 0.03); color: #ffffff; font-family: inherit; font-size: 0.9rem; outline: none;" />
          </div>
          <div style="display: flex; flex-direction: column; gap: 0.35rem;">
            <label style="font-size: 0.8rem; font-weight: 500; color: #94a3b8;">Category / Tag (EN) *</label>
            <input type="text" id="proj-tag-en" required placeholder="UI/UX Design" style="width: 100%; padding: 0.6rem 0.85rem; border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.1); background: rgba(255, 255, 255, 0.03); color: #ffffff; font-family: inherit; font-size: 0.9rem; outline: none;" />
          </div>
        </div>
        <div style="display: flex; flex-direction: column; gap: 0.35rem;">
          <label style="font-size: 0.8rem; font-weight: 500; color: #94a3b8;">Project Description (EN) *</label>
          <textarea id="proj-desc-en" required placeholder="Provide a brief project description, tech stack used, or general results." rows="2" style="width: 100%; padding: 0.6rem 0.85rem; border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.1); background: rgba(255, 255, 255, 0.03); color: #ffffff; font-family: inherit; font-size: 0.9rem; outline: none; resize: vertical;"></textarea>
        </div>
      </div>
      ...
      <div class="tab-content" id="tab-hu" style="display: none; flex-direction: column; gap: 1rem;">
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
          <div style="display: flex; flex-direction: column; gap: 0.35rem;">
            ...
            <input type="text" id="proj-title-hu" placeholder="Projekt Egy (defaults to English)" style="width: 100%; padding: 0.6rem 0.85rem; border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.1); background: rgba(255, 255, 255, 0.03); color: #ffffff; font-family: inherit; font-size: 0.9rem; outline: none;" />
          </div>
          <div style="display: flex; flex-direction: column; gap: 0.35rem;">
            <label style="font-size: 0.8rem; font-weight: 500; color: #94a3b8;">Category / Tag (HU)</label>
            <input type="text" id="proj-tag-hu" placeholder="UI/UX Tervezés" style="width: 100%; padding: 0.6rem 0.85rem; border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.1); background: rgba(255, 255, 255, 0.03); color: #ffffff; font-family: inherit; font-size: 0.9rem; outline: none;" />
          </div>
        </div>
        <div style="display: flex; flex-direction: column; gap: 0.35rem;">
          <label style="font-size: 0.8rem; font-weight: 500; color: #94a3b8;">Project Description (HU)</label>
          <textarea id="proj-desc-hu" placeholder="Projekt leírása..." rows="2" style="width: 100%; padding: 0.6rem 0.85rem; border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.1); background: rgba(255, 255, 255, 0.03); color: #ffffff; font-family: inherit; font-size: 0.9rem; outline: none; resize: vertical;"></textarea>
        </div>
      </div>
      ...
      <div class="tab-content" id="tab-ro" style="display: none; flex-direction: column; gap: 1rem;">
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
          <div style="display: flex; flex-direction: column; gap: 0.35rem;">
            ...
            <input type="text" id="proj-title-ro" placeholder="Proiect Unu (defaults to English)" style="width: 100%; padding: 0.6rem 0.85rem; border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.1); background: rgba(255, 255, 255, 0.03); color: #ffffff; font-family: inherit; font-size: 0.9rem; outline: none;" />
          </div>
          <div style="display: flex; flex-direction: column; gap: 0.35rem;">
            <label style="font-size: 0.8rem; font-weight: 500; color: #94a3b8;">Category / Tag (RO)</label>
            <input type="text" id="proj-tag-ro" placeholder="Design UI/UX" style="width: 100%; padding: 0.6rem 0.85rem; border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.1); background: rgba(255, 255, 255, 0.03); color: #ffffff; font-family: inherit; font-size: 0.9rem; outline: none;" />
          </div>
        </div>
        <div style="display: flex; flex-direction: column; gap: 0.35rem;">
          <label style="font-size: 0.8rem; font-weight: 500; color: #94a3b8;">Project Description (RO)</label>
          <textarea id="proj-desc-ro" placeholder="Descrierea proiectului..." rows="2" style="width: 100%; padding: 0.6rem 0.85rem; border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.1); background: rgba(255, 255, 255, 0.03); color: #ffffff; font-family: inherit; font-size: 0.9rem; outline: none; resize: vertical;"></textarea>
        </div>
      </div>
      ...
      <div style="border-top: 1px solid rgba(255, 255, 255, 0.05); padding-top: 1rem; display: flex; flex-direction: column; gap: 1rem;">
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
          <div style="display: flex; flex-direction: column; gap: 0.35rem;">
            <label style="font-size: 0.8rem; font-weight: 500; color: #94a3b8;">Project Image</label>
          ...
          <div style="display: flex; flex-direction: column; gap: 0.35rem;">
            ...
            <input type="text" id="proj-link" placeholder="#" style="width: 100%; padding: 0.6rem 0.85rem; border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.1); background: rgba(255, 255, 255, 0.03); color: #ffffff; font-family: inherit; font-size: 0.9rem; outline: none;" />
          </div>
        </div>
      ...
      <button type="submit" style="margin-top: 1rem; padding: 0.85rem; border-radius: 10px; border: none; background: linear-gradient(135deg, #3b82f6, #4f46e5); color: #ffffff; font-weight: 600; cursor: pointer; transition: opacity 0.3s, transform 0.2s; box-shadow: 0 4px 15px rgba(59, 130, 246, 0.35);">Create Project</button>
    </form>
  `;
